...
class Varios(models.Model):
    servicio = models.OneToOneField(Servicio, on_delete=models.CASCADE, related_name='varios')
...
class Ambulancia(models.Model):
    ...
    servicio = models.OneToOneField(Servicio, on_delete=models.CASCADE, related_name='ambulancia')
...
class Incendios(models.Model):
    ...
    servicio = models.OneToOneField(Servicio, on_delete=models.CASCADE, related_name='incendios')

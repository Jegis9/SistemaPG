...
class ServicioForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            'personal_asistente', 'observaciones', 'km_entrada', 'km_salida',
            'km_recorridos', 'servicio', 'fecha_hora'
        ]
        widgets = {
            ...
            'servicio': forms.RadioSelect,  # Renderizar como radio buttons
        }
...
class VariosForm(forms.ModelForm):
    servicio_de = forms.CharField(
        max_length=100, 
        required=False,  # No requerido por defecto
